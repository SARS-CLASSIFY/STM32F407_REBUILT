...
#define ADF4351_CE_PIN PBout(10) // reversed CS
#define ADF4351_LE_PIN PBout(11) // make postive pulse to update register
#define ADF4351_DATA_PIN PBout(12)
#define ADF4351_CLK_PIN PBout(13)
...
#define ADF4351_CE(__STATE__) 		ADF4351_CE_PIN=(__STATE__)
#define ADF4351_LE(__STATE__) 		ADF4351_LE_PIN=(__STATE__)
#define ADF4351_DATA(__STATE__) 	ADF4351_DATA_PIN=(__STATE__)
#define ADF4351_CLK(__STATE__) 		ADF4351_CLK_PIN=(__STATE__)
...
void ADF4351_GPIO_Init(void)
{
	...
	GPIO_SetBits(GPIOB,GPIO_Pin_10 | GPIO_Pin_11| GPIO_Pin_12|GPIO_Pin_13);//GPIOF9,F10设置高，灯灭
}

...
/*************128点数据*****************************/
//uint16_t Sine12bit[tableSize] = {
//0x0800,0x0864,0x08C9,0x092C,0x098F,0x09F1,0x0A52,0x0AB2,0x0B0F,0x0B6B,
//0x0BC5,0x0C1C,0x0C71,0x0CC3,0x0D13,0x0D5F,0x0DA7,0x0DED,0x0E2E,0x0E6C,
//0x0EA6,0x0EDC,0x0F0D,0x0F3A,0x0F63,0x0F87,0x0FA7,0x0FC2,0x0FD8,0x0FE9,
//0x0FF5,0x0FFD,0x0FFF,0x0FFD,0x0FF5,0x0FE9,0x0FD8,0x0FC2,0x0FA7,0x0F87,
//0x0F63,0x0F3A,0x0F0D,0x0EDC,0x0EA6,0x0E6C,0x0E2E,0x0DED,0x0DA7,0x0D5F,
//0x0D13,0x0CC3,0x0C71,0x0C1C,0x0BC5,0x0B6B,0x0B0F,0x0AB2,0x0A52,0x09F1,
//0x098F,0x092C,0x08C9,0x0864,0x0800,0x079C,0x0737,0x06D4,0x0671,0x060F,
//0x05AE,0x054E,0x04F1,0x0495,0x043B,0x03E4,0x038F,0x033D,0x02ED,0x02A1,
//0x0259,0x0213,0x01D2,0x0194,0x015A,0x0124,0x00F3,0x00C6,0x009D,0x0079,
//0x0059,0x003E,0x0028,0x0017,0x000B,0x0003,0x0001,0x0003,0x000B,0x0017,
//0x0028,0x003E,0x0059,0x0079,0x009D,0x00C6,0x00F3,0x0124,0x015A,0x0194,
//0x01D2,0x0213,0x0259,0x02A1,0x02ED,0x033D,0x038F,0x03E4,0x043B,0x0495,
//0x04F1,0x054E,0x05AE,0x060F,0x0671,0x06D4,0x0737,0x079C,};
...
0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,
0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,0x0FFF,
0x0FFF,0x0FFF,0x0FFF,0x0FFF,0X0FFF,0X0FFF,
};

uint16_t Sine12bit[tableSize] = {
0x0800,0x08C8,0x098F,0x0A52,0x0B0F,0x0BC5,0x0C71,
0x0D12,0x0DA7,0x0E2E,0x0EA6,0x0F0D,0x0F63,0x0FA7,
0x0FD8,0x0FF5,0x0FFF,0x0FF5,0x0FD8,0x0FA7,0x0F63,
0x0F0D,0x0EA6,0x0E2E,0x0DA7,0x0D12,0x0C71,0x0BC5,
0x0B0F,
0x0A52,
0x098F,
0x08C8,
...
uint16_t sawtooth[tableSize] = {
0x0000,0x0080,0x0100,0x0180,0x0200,0x0280,0x0300,0x0380,0x0400,
0x0480,0x0500,0x0580,0x0600,0x0680,0x0700,0x0780,0x0800,0x087F,
0x08FF,0x097F,0x09FF,0x0A7F,0x0AFF,0x0B7F,0x0BFF,0x0C7F,0x0CFF,
0x0D7F,0x0DFF,0x0E7F,0x0EFF,0x0F7F,0x0FFF,0x0F7F,0x0EFF,0x0E7F,
0x0DFF,0x0D7F,0x0CFF,0x0C7F,0x0BFF,0x0B7F,0x0AFF,0x0A7F,0x09FF,
0x097F,0x08FF,0x087F,0x0800,0x0780,0x0700,0x0680,0x0600,0x0580,
...
uint16_t sin_out[tableSize] = {0};
uint16_t tri_out[tableSize] = {0};
uint16_t rec_out[tableSize] = {0};
...
{	
  ...
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&sin_out ;			//内存数据地址 DualSine12bit
  ...
  //DAC2的DMA使能
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&sawtooth ;				//更改输出波形  ***>_<***
...
void set_vol(uint16_t VPP, uint16_t * sin_out,uint16_t * tri_out)
{
	...
	for(i=0;i<tableSize;i++){
		sin_out[i] = Sine12bit[i]*VPP/3300;
		tri_out[i] = Tri_12bit[i]*VPP/3300;
		rec_out[i] = Rec12bit[i]*VPP/3300;
	}
}
